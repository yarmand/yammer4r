...
describe Yammer::OAuthClient do
  ...
  context "users" do
    ...
    before(:each) do
      ...
      @client = Yammer::OAuthClient.new(:consumer => {}, :access => {})
    end
